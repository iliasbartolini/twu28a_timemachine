...
# Source: https://github.com/jcarver989/phantom-jasmine
...
class PhantomJasmineRunner
  ...
  get_status: -> @page.evaluate(-> consoleReporter.status) # console_reporter modified to following JS naming convention
